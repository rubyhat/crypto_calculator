      ...
      <div>
        ...
        <form>
          <div className="from-group">
            ...
            <input onChange={this.props.handleChange} autoComplete="off" type="text" name="name" placeholder="Ex: Bitcoin, Litecoin, Ethereum, etc ..." value={this.props.name} className="field" />
          </div>
